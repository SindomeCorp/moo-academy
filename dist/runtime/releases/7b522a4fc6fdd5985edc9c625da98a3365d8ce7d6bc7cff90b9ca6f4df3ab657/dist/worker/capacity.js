...
export function transferCapacity(limits) {
    ...
    if (!Number.isSafeInteger(maxCharacters) || !Number.isSafeInteger(maxNodes))
        throw new HostError('World quotas exceed safe worker transfer capacity');
