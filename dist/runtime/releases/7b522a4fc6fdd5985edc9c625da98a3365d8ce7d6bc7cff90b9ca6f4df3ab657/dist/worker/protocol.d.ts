...
export type WarmupRequest = Omit<ExecuteRequest, 'type' | 'source' | 'context' | 'limits'> & {
    type: 'warmup';
};
...
export interface WireRuntimeDiagnostic {
...
export type WireResult = {
    ...
    diagnostics: readonly WireRuntimeDiagnostic[];
} | {
