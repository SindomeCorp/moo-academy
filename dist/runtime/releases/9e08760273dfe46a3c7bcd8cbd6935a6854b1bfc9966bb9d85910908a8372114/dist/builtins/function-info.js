...
export function functionInfo(args, profile, budget) {
    ...
    if (args.length) {
        ...
        if (!info)
            fail('E_INVARG', 'Unknown builtin: ' + name.value);
